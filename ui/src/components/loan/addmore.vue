            ...
            <div class=" mx-auto p-4 flex-wrap">
              <div class="crud-form-panel w-full flex flex-wrap ">
                <n-form 
                  ...
                  ref="formRef"
                >
                  <n-form-item label="ទឹកប្រាក់បន្ថែម កម្ចី (USD)" path="amount" class="w-4/5 mr-8" >
                    <n-input-number :min="0" :max="1000000" v-model:value="amount" clearable placeholder="ទឹកប្រាក់បន្ថែម កម្ចី (USD)"/>
                  </n-form-item>
...
export default {
  ...
  setup(props){
    ...
    function create(){
      ...
      store.dispatch( props.model.name+'/addmore',{
