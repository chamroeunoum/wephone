<template>
  ...
  <!-- Top action panel of crud -->
    ...
    <div class="vcb-table-panel relative">
      <table class="vcb-table" >
        <tr class="vcb-table-headers" >
          ...
          <th class="vcb-table-header">កូដ</th>
          <th class="vcb-table-header">សមតុល្យ (USD)</th>
          <th class="vcb-table-header">អាត្រាការប្រាក់ (%)</th>
          <th class="vcb-table-header">ថ្ងៃចាប់ផ្ដើម</th>
          <th class="vcb-table-header">អាយុកម្ចី (ខែ)</th>
        ...
        <tr v-for="(record, index) in table.records.matched" :key='index' class="vcb-table-row" >
          ...
          <td class="vcb-table-cell" >{{ record.people.lastname + " " + record.people.firstname }}</td>
          <td  class="vcb-table-cell" >{{ record.code }}</td>
          <td  class="vcb-table-cell" >{{ record.balance }}</td>
          <td class="vcb-table-cell" >{{ record.rate }}</td>
          <td class="vcb-table-cell" >{{ record.start_date }}</td>
    ...
    <transaction-form v-bind:model="model" v-bind:show="transactionModal.show" :onClose="closeTransactionModal" :repayback="repayback" />
    <!-- Form schedule account -->
    <schedule-form v-bind:model="model" v-bind:show="scheduleModal.show" :onClose="closeScheduleModal" :schedule="schedule" :record="selectedRecord" />
    <!-- Form create account -->
    ...
    <!-- Form add more loan -->
    <add-more-form v-bind:model="model" v-bind:show="addMoreLoanModal.show" :onClose="closeAddMoreLoanModal" :record="selectedRecord" />
    <!-- Form repayment loan -->
    <repayback-form v-bind:model="model" v-bind:show="repaybackLoanModal.show" :onClose="closeRepaybackLoanModal" :record="selectedRecord" />
  </div>
</template>
<script>
...
import AddMoreForm from './addmore.vue'
import RepaybackForm from './repayback.vue'
export default {
  name: "User" ,
  components: {
    QrcodeVue ,
  ...
  setup(){
    ...
    return {
       ...
       */
      addMoreLoanModal ,
      showAddMoreLoanModal ,
      closeAddMoreLoanModal ,
      /**
       * Repayback loan
       */
      repaybackLoanModal ,
      showRepaybackLoanModal ,
      closeRepaybackLoanModal ,
      /**
       * Functions
       */
      deleteRecord ,
