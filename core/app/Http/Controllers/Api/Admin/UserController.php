...
class UserController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if( $user ){
            ...
            // $client = ['name' => 'Client']
            $backendMember = \App\Models\Role::where('name' , 'Backend member')->first();            
            if( $backendMember !== null ) $user->assignRole( $backendMember );
    ...
    public function update(Request $request){
        ...
        if( $user && $user->update([
            ...
            $backendMember = \App\Models\Role::find( $request->role_id );
            if( $backendMember !== null ) $user->assignRole( $backendMember );
